...
<!--This HTML document is my first exercise for Art 277-->
<!DOCTYPE html>
<html lang="en">
  <!--The head starts here-->
<head>
<meta charset="utf-8">
<meta htt-equiv="content-Type" content="text/html;>
<meta name="author" content="Emmett Manthar">
<title>Assignment one</title>
</head>
<!--The head Ends and the body starts after-->
<body>
<address align="right">
...
as part of your <abbr title="Doctor of philosophy">PhD</abbr> next year. I will answer your questions one by one, in the following sections.</p>

<h2>Starting dates</h2>

<p></p>We are happy to accommodate you starting your study with us at any time, however it would suit 
...
<p></p>Please let me know if this is ok, and if so which start date you would prefer.</p>
...
<p>Turning H<sub>2</sub>O into wine, and the health benefits of Resveratrol (C<sub>14</sub>H<sub>12</sub>O<sub><sub>3</sub>.)
Measuring the effect on performance of funk bassplayers at temperatures exceeding 30°C (86°F), 
when the audience size exponentially increases (effect of<sup>3</sup> × 103
increasing to 3 ×<sup>4</sup>10</p>.)
...
expect the research to take, required staff and other resources, and anything else you think we'd need to know? Thanks.</p>
...
<p>For more of my research, see my exotic dance research page.</p><br><br>
